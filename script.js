...
function saveCharacter(){
	...
	displayCharactersList();
	document.getElementById("add-character-name").value="";
	document.getElementById("add-character-power").value="";
	document.getElementById("add-character-role").value="";
	document.getElementById("add-character-picture-input").value = "";
	document.getElementById("add-character-picture").src="";
}
